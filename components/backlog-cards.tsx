...
export function BoardingPass({ flight }: { flight: Flight }): React.JSX.Element {
  return (
    <Box position="relative" bg="mario.surface2" borderWidth="1px" borderColor="mario.line" borderRadius="12px" mx="16px" my="10px" overflow="hidden">
      <Flex justify="space-between" align="center" px="16px" py="10px" style={{ background: 'rgba(229,37,33,0.26)' }}>
      ...
      <Box px="16px" pt="14px" pb="16px">
        <Flex align="center">
          <Box>
            ...
            <Box fontFamily="pixel" fontSize="7px" color="mario.faint" mt="7px">
              {flight.from}
            </Box>
          </Box>
          <Flex flex="1" align="center" gap="4px" mx="4px">
            <Box w="5px" h="5px" borderRadius="50%" bg="mario.faint" flexShrink={0} />
            <Box flex="1" borderTopWidth="1px" borderTopStyle="dashed" borderColor="rgba(235,240,255,0.25)" />
      ...
      <Flex position="relative" justify="space-between" align="center" px="16px" py="11px" borderTopWidth="1px" borderTopStyle="dashed" borderColor="rgba(235,240,255,0.22)">
...
export function HotelCard({ room }: { room: Room }): React.JSX.Element {
  return (
    <Box bg="mario.surface2" borderWidth="1px" borderColor="mario.line" borderRadius="12px" mx="16px" my="10px" overflow="hidden">
      ...
      <Flex align="center" gap="12px" px="16px" py="12px" borderYWidth="1px" borderColor="mario.line" style={{ background: 'rgba(67,176,71,0.08)' }}>
        <Box flex="1">
        ...
        {room.nights !== null && (
          <Box fontFamily="mono" fontSize="11px" fontWeight="500" color="mario.greenT" borderWidth="1px" borderColor="rgba(67,176,71,0.4)" borderRadius="999px" px="10px" py="5px" flexShrink={0}>
            {room.nights} 晚
          </Box>
        )}
      ...
      <Box px="16px" pt="10px" pb="13px">
        ...
        {room.addressOrLink && (
          <KvRow k="地址">
            <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(room.addressOrLink)}`} target="_blank" rel="noreferrer">
              {room.addressOrLink} ↗
            </a>
          </KvRow>
        )}
...
export function TicketRow({ ticket }: { ticket: UsjTicket }): React.JSX.Element {
  const meta = [
    ...
    .join(' · ');
  return (
    <Flex bg="mario.surface2" borderWidth="1px" borderColor="mario.line" borderRadius="10px" mx="16px" my="8px" overflow="hidden" align="stretch">
      ...
      <Flex w="92px" flexShrink={0} align="center" justify="center" borderLeftWidth="1px" borderLeftStyle="dashed" borderColor="rgba(235,240,255,0.22)">
...
export function BnbCard({ bnb }: { bnb: BnbCandidate }): React.JSX.Element {
  return (
    <Box bg="mario.surface" borderWidth="1px" borderColor="mario.line" borderRadius="12px" mx="16px" my="10px" px="16px" py="14px">
      <Flex justify="space-between" align="center">
        <Flex align="center" gap="8px">
          ...
          {bnb.rating && (
            <Box fontFamily="mono" fontSize="12px" fontWeight="600" color="mario.yellow">
              {bnb.rating}
            </Box>
          )}
        </Flex>
      ...
      <Box mt="8px">
        <KvRow k="位置">
          {[bnb.areaStation, bnb.walkToStation].filter(Boolean).join(' ')}
        </KvRow>
        <KvRow k="價格">
          <Box as="span" fontFamily="mono" fontSize="12px">
            {[bnb.pricePerNight && `${bnb.pricePerNight}/晚`, bnb.totalPriceEst].filter(Boolean).join(' · ')}
          </Box>
        </KvRow>
        ...
        <Box mt="8px">
          {bnb.pros && (
            <Flex gap="8px" fontSize="12px" py="3px">
              <Box fontFamily="mono" fontSize="11px" fontWeight="500" w="14px" flexShrink={0} color="mario.greenT">
                +
              </Box>
          ...
          {bnb.cons && (
            <Flex gap="8px" fontSize="12px" py="3px">
              <Box fontFamily="mono" fontSize="11px" fontWeight="500" w="14px" flexShrink={0} color="mario.redT">
                −
              </Box>
